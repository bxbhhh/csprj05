...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_ABS2008;
#else
  int x_TARGET_ABS2008;
#define TARGET_ABS2008 global_options.x_TARGET_ABS2008
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_NAN2008;
#else
  int x_TARGET_NAN2008;
#define TARGET_NAN2008 global_options.x_TARGET_NAN2008
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_Wcondition_assign = 189,               /* -Wcondition-assign */
  OPT_Wconstructor_name = 190,               /* -Wconstructor-name */
  OPT_Wconversion = 191,                     /* -Wconversion */
  OPT_Wconversion_extra = 192,               /* -Wconversion-extra */
  OPT_Wconversion_null = 193,                /* -Wconversion-null */
  OPT_Wcoverage_mismatch = 194,              /* -Wcoverage-mismatch */
  OPT_Wcpp = 195,                            /* -Wcpp */
  OPT_Wctor_dtor_privacy = 196,              /* -Wctor-dtor-privacy */
  OPT_Wdeclaration_after_statement = 197,    /* -Wdeclaration-after-statement */
  OPT_Wdelete_non_virtual_dtor = 198,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdep_ann = 199,                        /* -Wdep-ann */
  OPT_Wdeprecated = 200,                     /* -Wdeprecated */
  OPT_Wdeprecated_declarations = 201,        /* -Wdeprecated-declarations */
  OPT_Wdisabled_optimization = 202,          /* -Wdisabled-optimization */
  OPT_Wdiscouraged = 203,                    /* -Wdiscouraged */
  OPT_Wdiv_by_zero = 204,                    /* -Wdiv-by-zero */
  OPT_Wdouble_promotion = 205,               /* -Wdouble-promotion */
  OPT_Weffc__ = 206,                         /* -Weffc++ */
  OPT_Wempty_block = 207,                    /* -Wempty-block */
  OPT_Wempty_body = 208,                     /* -Wempty-body */
  OPT_Wendif_labels = 209,                   /* -Wendif-labels */
  OPT_Wenum_compare = 210,                   /* -Wenum-compare */
  OPT_Wenum_identifier = 211,                /* -Wenum-identifier */
  OPT_Wenum_switch = 212,                    /* -Wenum-switch */
  OPT_Werror = 213,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 214, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 215,                         /* -Werror= */
  OPT_Wextra = 216,                          /* -Wextra */
  OPT_Wextraneous_semicolon = 217,           /* -Wextraneous-semicolon */
  OPT_Wfallthrough = 218,                    /* -Wfallthrough */
  OPT_Wfatal_errors = 219,                   /* -Wfatal-errors */
  OPT_Wfield_hiding = 220,                   /* -Wfield-hiding */
  OPT_Wfinal_bound = 221,                    /* -Wfinal-bound */
  OPT_Wfinally = 222,                        /* -Wfinally */
  OPT_Wfloat_equal = 223,                    /* -Wfloat-equal */
  OPT_Wforbidden = 224,                      /* -Wforbidden */
  OPT_Wformat = 225,                         /* -Wformat */
  OPT_Wformat_contains_nul = 226,            /* -Wformat-contains-nul */
  OPT_Wformat_extra_args = 227,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 228,              /* -Wformat-nonliteral */
  OPT_Wformat_security = 229,                /* -Wformat-security */
  OPT_Wformat_y2k = 230,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 231,             /* -Wformat-zero-length */
  OPT_Wformat_ = 232,                        /* -Wformat= */
  OPT_Wframe_larger_than_ = 233,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 234,            /* -Wfree-nonheap-object */
  OPT_Wfunction_elimination = 235,           /* -Wfunction-elimination */
  OPT_Whiding = 236,                         /* -Whiding */
  OPT_Wignored_qualifiers = 237,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 238,                       /* -Wimplicit */
  OPT_Wimplicit_function_declaration = 239,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 240,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 241,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 242,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 243, */                   /* -Wimport */
  OPT_Windirect_static = 244,                /* -Windirect-static */
  OPT_Winit_self = 245,                      /* -Winit-self */
  OPT_Winline = 246,                         /* -Winline */
  OPT_Wint_to_pointer_cast = 247,            /* -Wint-to-pointer-cast */
  OPT_Wintf_annotation = 248,                /* -Wintf-annotation */
  OPT_Wintf_non_inherited = 249,             /* -Wintf-non-inherited */
  OPT_Wintrinsic_shadow = 250,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 251,                 /* -Wintrinsics-std */
  OPT_Winvalid_memory_model = 252,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 253,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 254,                    /* -Winvalid-pch */
  OPT_Wjavadoc = 255,                        /* -Wjavadoc */
  OPT_Wjump_misses_init = 256,               /* -Wjump-misses-init */
  OPT_Wl_ = 257,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 258, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 259,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 260,                /* -Wline-truncation */
  ...
  OPT_Wpkg_default_method = 302,             /* -Wpkg-default-method */
  OPT_Wpmf_conversions = 303,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 304,                  /* -Wpointer-arith */
  OPT_Wpointer_sign = 305,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 306,            /* -Wpointer-to-int-cast */
  OPT_Wpoison_system_directories = 307,      /* -Wpoison-system-directories */
  ...
  OPT_Wredundant_decls = 314,                /* -Wredundant-decls */
  OPT_Wredundant_modifiers = 315,            /* -Wredundant-modifiers */
  OPT_Wreorder = 316,                        /* -Wreorder */
  OPT_Wreturn_type = 317,                    /* -Wreturn-type */
  OPT_Wselector = 318,                       /* -Wselector */
  OPT_Wsequence_point = 319,                 /* -Wsequence-point */
  OPT_Wserial = 320,                         /* -Wserial */
  OPT_Wshadow = 321,                         /* -Wshadow */
  OPT_Wsign_compare = 322,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 323,                /* -Wsign-conversion */
  OPT_Wsign_promo = 324,                     /* -Wsign-promo */
  OPT_Wspecial_param_hiding = 325,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 326,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 327,                   /* -Wstack-usage= */
  OPT_Wstatic_access = 328,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 329,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 330,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 331,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 332,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 333,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 334,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 335,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 336,          /* -Wstrict-selector-match */
  OPT_Wsuggest_attribute_const = 337,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_noreturn = 338,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 339,         /* -Wsuggest-attribute=pure */
  OPT_Wsuppress = 340,                       /* -Wsuppress */
  OPT_Wsurprising = 341,                     /* -Wsurprising */
  OPT_Wswitch = 342,                         /* -Wswitch */
  OPT_Wswitch_default = 343,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 344,                    /* -Wswitch-enum */
  OPT_Wsync_nand = 345,                      /* -Wsync-nand */
  OPT_Wsynth = 346,                          /* -Wsynth */
  OPT_Wsynthetic_access = 347,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 348,                 /* -Wsystem-headers */
  OPT_Wtabs = 349,                           /* -Wtabs */
  OPT_Wtasks = 350,                          /* -Wtasks */
  OPT_Wtraditional = 351,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 352,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 353,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 354,                      /* -Wtrigraphs */
  OPT_Wtype_hiding = 355,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 356,                    /* -Wtype-limits */
  OPT_Wuncheck = 357,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 358,            /* -Wundeclared-selector */
  OPT_Wundef = 359,                          /* -Wundef */
  OPT_Wunderflow = 360,                      /* -Wunderflow */
  OPT_Wuninitialized = 361,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 362,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 363,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 364,              /* -Wunqualified-field */
  /* OPT_Wunreachable_code = 365, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 366,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 367,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 368,                         /* -Wunused */
  OPT_Wunused_argument = 369,                /* -Wunused-argument */
  OPT_Wunused_but_set_parameter = 370,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 371,        /* -Wunused-but-set-variable */
  OPT_Wunused_dummy_argument = 372,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 373,                /* -Wunused-function */
  OPT_Wunused_import = 374,                  /* -Wunused-import */
  OPT_Wunused_label = 375,                   /* -Wunused-label */
  OPT_Wunused_local = 376,                   /* -Wunused-local */
  OPT_Wunused_local_typedefs = 377,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 378,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 379,               /* -Wunused-parameter */
  OPT_Wunused_private = 380,                 /* -Wunused-private */
  OPT_Wunused_result = 381,                  /* -Wunused-result */
  OPT_Wunused_thrown = 382,                  /* -Wunused-thrown */
  OPT_Wunused_value = 383,                   /* -Wunused-value */
  OPT_Wunused_variable = 384,                /* -Wunused-variable */
  ...
  OPT_fextension_elimination = 564,          /* -fextension-elimination */
  OPT_fexternal_blas = 565,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 566, */       /* -fexternal-templates */
  OPT_ff2c = 567,                            /* -ff2c */
  OPT_ffast_math = 568,                      /* -ffast-math */
  OPT_ffat_lto_objects = 569,                /* -ffat-lto-objects */
  OPT_ffeature_proxy = 570,                  /* -ffeature-proxy */
  OPT_ffilelist_file = 571,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 572,               /* -ffinite-math-only */
  OPT_ffixed_ = 573,                         /* -ffixed- */
  OPT_ffixed_form = 574,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 575,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 576,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 577,                    /* -ffloat-store */
  OPT_ffor_scope = 578,                      /* -ffor-scope */
  /* OPT_fforce_addr = 579, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 580,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 581,              /* -fforward-propagate */
  OPT_ffp_contract_ = 582,                   /* -ffp-contract= */
  OPT_ffpe_trap_ = 583,                      /* -ffpe-trap= */
  OPT_ffree_form = 584,                      /* -ffree-form */
  OPT_ffree_line_length_ = 585,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 586,          /* -ffree-line-length-none */
  OPT_ffreestanding = 587,                   /* -ffreestanding */
  OPT_ffriend_injection = 588,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 589,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 590,                   /* -ffunction-cse */
  OPT_ffunction_sections = 591,              /* -ffunction-sections */
  OPT_fgcse = 592,                           /* -fgcse */
  OPT_fgcse_after_reload = 593,              /* -fgcse-after-reload */
  OPT_fgcse_las = 594,                       /* -fgcse-las */
  OPT_fgcse_lm = 595,                        /* -fgcse-lm */
  OPT_fgcse_sm = 596,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 597,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 598,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 599,                         /* -fgnu-tm */
  OPT_fgnu89_inline = 600,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 601,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 602,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 603,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 604,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 605,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 606,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 607,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 608,                       /* -fgraphite */
  OPT_fgraphite_identity = 609,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 610,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 611, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 612, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 613,           /* -fhash-synchronization */
  /* OPT_fhelp = 614, */                     /* -fhelp */
  /* OPT_fhelp_ = 615, */                    /* -fhelp= */
  /* OPT_fhonor_std = 616, */                /* -fhonor-std */
  OPT_fhosted = 617,                         /* -fhosted */
  /* OPT_fhuge_objects = 618, */             /* -fhuge-objects */
  OPT_fident = 619,                          /* -fident */
  OPT_fif_conversion = 620,                  /* -fif-conversion */
  OPT_fif_conversion2 = 621,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 622,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 623,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 624,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 625,             /* -fimplicit-templates */
  OPT_findirect_classes = 626,               /* -findirect-classes */
  OPT_findirect_dispatch = 627,              /* -findirect-dispatch */
  OPT_findirect_inlining = 628,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 629,         /* -finhibit-size-directive */
  OPT_finit_character_ = 630,                /* -finit-character= */
  OPT_finit_integer_ = 631,                  /* -finit-integer= */
  OPT_finit_local_zero = 632,                /* -finit-local-zero */
  OPT_finit_logical_ = 633,                  /* -finit-logical= */
  OPT_finit_real_ = 634,                     /* -finit-real= */
  OPT_finline = 635,                         /* -finline */
  OPT_finline_atomics = 636,                 /* -finline-atomics */
  OPT_finline_functions = 637,               /* -finline-functions */
  OPT_finline_functions_called_once = 638,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 639, */            /* -finline-limit- */
  OPT_finline_limit_ = 640,                  /* -finline-limit= */
  OPT_finline_small_functions = 641,         /* -finline-small-functions */
  OPT_finput_charset_ = 642,                 /* -finput-charset= */
  OPT_finstrument_function_calls = 643,      /* -finstrument-function-calls */
  OPT_finstrument_functions = 644,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 645,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 646,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 647,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 648,         /* -fintrinsic-modules-path */
  OPT_fipa_cp = 649,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 650,                   /* -fipa-cp-clone */
  OPT_fipa_matrix_reorg = 651,               /* -fipa-matrix-reorg */
  OPT_fipa_profile = 652,                    /* -fipa-profile */
  OPT_fipa_pta = 653,                        /* -fipa-pta */
  OPT_fipa_pure_const = 654,                 /* -fipa-pure-const */
  OPT_fipa_reference = 655,                  /* -fipa-reference */
  OPT_fipa_sra = 656,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 657, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 658,                 /* -fira-algorithm= */
  OPT_fira_loop_pressure = 659,              /* -fira-loop-pressure */
  OPT_fira_region_ = 660,                    /* -fira-region= */
  OPT_fira_share_save_slots = 661,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 662,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 663,                   /* -fira-verbose= */
  OPT_fivopts = 664,                         /* -fivopts */
  OPT_fjni = 665,                            /* -fjni */
  OPT_fjump_tables = 666,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 667,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 668,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 669,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 670, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 671,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 672,             /* -fleading-underscore */
  OPT_flicense_me = 673,                     /* -flicense-me */
  OPT_floop_block = 674,                     /* -floop-block */
  OPT_floop_flatten = 675,                   /* -floop-flatten */
  OPT_floop_interchange = 676,               /* -floop-interchange */
  /* OPT_floop_optimize = 677, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 678,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 679,                /* -floop-strip-mine */
  OPT_flto = 680,                            /* -flto */
  OPT_flto_compression_level_ = 681,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 682,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 683,         /* -flto-partition=balanced */
  OPT_flto_partition_none = 684,             /* -flto-partition=none */
  OPT_flto_report = 685,                     /* -flto-report */
  OPT_flto_ = 686,                           /* -flto= */
  OPT_fltrans = 687,                         /* -fltrans */
  OPT_fltrans_output_list_ = 688,            /* -fltrans-output-list= */
  OPT_fmain_ = 689,                          /* -fmain= */
  OPT_fmath_errno = 690,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 691,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 692,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 693,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 694,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 695,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 696,                     /* -fmem-report */
  OPT_fmerge_all_constants = 697,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 698,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 699,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 700,                /* -fmessage-length= */
  OPT_fmodule_private = 701,                 /* -fmodule-private */
  OPT_fmodulo_sched = 702,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 703,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 704,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 705,                  /* -fms-extensions */
  OPT_fmudflap = 706,                        /* -fmudflap */
  OPT_fmudflapir = 707,                      /* -fmudflapir */
  OPT_fmudflapth = 708,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 709, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 710, */                  /* -fnew-abi */
  OPT_fnext_runtime = 711,                   /* -fnext-runtime */
  OPT_fnil_receivers = 712,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 713,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 714,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 715, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 716,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 717,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 718,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 719,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 720,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 721,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 722,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 723,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 724,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 725,             /* -fomit-frame-pointer */
  OPT_fopenmp = 726,                         /* -fopenmp */
  OPT_foperator_names = 727,                 /* -foperator-names */
  OPT_foptimize_register_move = 728,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 729,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 730,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 731,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 732, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 733,              /* -foutput-class-dir= */
  OPT_fpack_derived = 734,                   /* -fpack-derived */
  OPT_fpack_struct = 735,                    /* -fpack-struct */
  OPT_fpack_struct_ = 736,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 737,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 738,              /* -fpcc-struct-return */
  OPT_fpch_deps = 739,                       /* -fpch-deps */
  OPT_fpch_preprocess = 740,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 741,                     /* -fpeel-loops */
  OPT_fpeephole = 742,                       /* -fpeephole */
  OPT_fpeephole2 = 743,                      /* -fpeephole2 */
  OPT_fpermissive = 744,                     /* -fpermissive */
  OPT_fpic = 745,                            /* -fpic */
  OPT_fpie = 746,                            /* -fpie */
  OPT_fplan9_extensions = 747,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 748,                    /* -fplugin-arg- */
  OPT_fplugin_ = 749,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 750,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 751,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 752,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 753,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 754,                   /* -fpreprocessed */
  OPT_fpretty_templates = 755,               /* -fpretty-templates */
  OPT_fprofile = 756,                        /* -fprofile */
  OPT_fprofile_arcs = 757,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 758,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 759,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 760,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 761,              /* -fprofile-generate= */
  OPT_fprofile_use = 762,                    /* -fprofile-use */
  OPT_fprofile_use_ = 763,                   /* -fprofile-use= */
  OPT_fprofile_values = 764,                 /* -fprofile-values */
  OPT_fpromote_loop_indices = 765,           /* -fpromote-loop-indices */
  OPT_fprotect_parens = 766,                 /* -fprotect-parens */
  OPT_frandom_seed = 767,                    /* -frandom-seed */
  OPT_frandom_seed_ = 768,                   /* -frandom-seed= */
  OPT_frange_check = 769,                    /* -frange-check */
  OPT_freal_4_real_10 = 770,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 771,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 772,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 773,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 774,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 775,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 776,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 777,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 778,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 779,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 780,                /* -frecord-marker=8 */
  OPT_frecursive = 781,                      /* -frecursive */
  OPT_freduced_reflection = 782,             /* -freduced-reflection */
  OPT_free = 783,                            /* -free */
  OPT_freg_struct_return = 784,              /* -freg-struct-return */
  OPT_fregmove = 785,                        /* -fregmove */
  OPT_fremove_local_statics = 786,           /* -fremove-local-statics */
  OPT_frename_registers = 787,               /* -frename-registers */
  OPT_freorder_blocks = 788,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 789,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 790,              /* -freorder-functions */
  OPT_frepack_arrays = 791,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 792,           /* -freplace-objc-classes */
  OPT_frepo = 793,                           /* -frepo */
  OPT_frequire_return_statement = 794,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 795,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 796, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 797,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 798,                    /* -fresolution= */
  OPT_frounding_math = 799,                  /* -frounding-math */
  OPT_frtti = 800,                           /* -frtti */
  OPT_fsaw_java_file = 801,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 802,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 803,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 804,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 805,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 806,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 807,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 808,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 809,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 810,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 811,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 812,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 813,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 814,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 815,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 816,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 817,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 818,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 819, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 820,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 821,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 822,              /* -fsecond-underscore */
  OPT_fsection_anchors = 823,                /* -fsection-anchors */
  /* OPT_fsee = 824, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 825,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 826,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 827, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 828,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 829,          /* -fselective-scheduling2 */
  OPT_fshort_double = 830,                   /* -fshort-double */
  OPT_fshort_enums = 831,                    /* -fshort-enums */
  OPT_fshort_wchar = 832,                    /* -fshort-wchar */
  OPT_fshow_column = 833,                    /* -fshow-column */
  OPT_fshrink_wrap = 834,                    /* -fshrink-wrap */
  OPT_fsign_zero = 835,                      /* -fsign-zero */
  OPT_fsignaling_nans = 836,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 837,               /* -fsigned-bitfields */
  OPT_fsigned_char = 838,                    /* -fsigned-char */
  OPT_fsigned_zeros = 839,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 840,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 841,               /* -fsource-filename= */
  OPT_fsource_ = 842,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 843,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 844,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 845,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 846, */                 /* -fsquangle */
  OPT_fstack_arrays = 847,                   /* -fstack-arrays */
  /* OPT_fstack_check = 848, */              /* -fstack-check */
  OPT_fstack_check_ = 849,                   /* -fstack-check= */
  OPT_fstack_limit = 850,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 851,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 852,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 853,                /* -fstack-protector */
  OPT_fstack_protector_all = 854,            /* -fstack-protector-all */
  OPT_fstack_usage = 855,                    /* -fstack-usage */
  OPT_fstats = 856,                          /* -fstats */
  OPT_fstore_check = 857,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 858, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 859,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 860,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 861,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 862, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 863,      /* -fstrict-volatile-bitfields */
  OPT_fsyntax_only = 864,                    /* -fsyntax-only */
  OPT_ftabstop_ = 865,                       /* -ftabstop= */
  /* OPT_ftarget_help = 866, */              /* -ftarget-help */
  OPT_ftarget_ = 867,                        /* -ftarget= */
  /* OPT_ftemplate_depth_ = 868, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 869,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 870,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 871, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 872,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 873,             /* -fthreadsafe-statics */
  OPT_ftime_report = 874,                    /* -ftime-report */
  OPT_ftls_model_ = 875,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 876,               /* -ftoplevel-reorder */
  OPT_ftracer = 877,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 878,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 879,         /* -ftrack-macro-expansion= */
  ...
  OPT_ftree_if_to_switch_conversion = 894,   /* -ftree-if-to-switch-conversion */
  OPT_ftree_loop_distribute_patterns = 895,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 896,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 897,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 898,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 899,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 900,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 901, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 902,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 903,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 904,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 905,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 906,                   /* -ftree-phiprop */
  OPT_ftree_pre = 907,                       /* -ftree-pre */
  OPT_ftree_pta = 908,                       /* -ftree-pta */
  OPT_ftree_reassoc = 909,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 910, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 911,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 912,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 913,             /* -ftree-slp-vectorize */
  OPT_ftree_sra = 914,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 915, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 916, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 917,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 918,                /* -ftree-tail-merge */
  OPT_ftree_ter = 919,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 920,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 921,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 922,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 923,                       /* -ftree-vrp */
  OPT_funderscoring = 924,                   /* -funderscoring */
  OPT_funit_at_a_time = 925,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 926,               /* -funroll-all-loops */
  OPT_funroll_loops = 927,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 928,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 929,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 930,             /* -funsigned-bitfields */
  OPT_funsigned_char = 931,                  /* -funsigned-char */
  OPT_funswitch_loops = 932,                 /* -funswitch-loops */
  OPT_funwind_tables = 933,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 934,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 935,                   /* -fuse-boehm-gc */
  OPT_fuse_caller_save = 936,                /* -fuse-caller-save */
  OPT_fuse_cxa_atexit = 937,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 938,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 939,          /* -fuse-divide-subroutine */
  OPT_fuse_linker_plugin = 940,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 941,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 942,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 943,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 944,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 945, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 946,                /* -fvect-cost-model */
  OPT_fverbose_asm = 947,                    /* -fverbose-asm */
  /* OPT_fversion = 948, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 949,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 950,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 951,                    /* -fvisibility= */
  OPT_fvpt = 952,                            /* -fvpt */
  /* OPT_fvtable_gc = 953, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 954, */            /* -fvtable-thunks */
  OPT_fweak = 955,                           /* -fweak */
  OPT_fweb = 956,                            /* -fweb */
  OPT_fwhole_file = 957,                     /* -fwhole-file */
  OPT_fwhole_program = 958,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 959,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 960,              /* -fworking-directory */
  OPT_fwpa = 961,                            /* -fwpa */
  OPT_fwrapv = 962,                          /* -fwrapv */
  /* OPT_fxref = 963, */                     /* -fxref */
  /* OPT_fzee = 964, */                      /* -fzee */
  OPT_fzero_initialized_in_bss = 965,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 966,                      /* -fzero-link */
  OPT_g = 967,                               /* -g */
  OPT_gant = 968,                            /* -gant */
  OPT_gcoff = 969,                           /* -gcoff */
  OPT_gdwarf_ = 970,                         /* -gdwarf- */
  OPT_gen_decls = 971,                       /* -gen-decls */
  OPT_ggdb = 972,                            /* -ggdb */
  OPT_gnat = 973,                            /* -gnat */
  OPT_gnatO = 974,                           /* -gnatO */
  OPT_gno_record_gcc_switches = 975,         /* -gno-record-gcc-switches */
  OPT_gno_strict_dwarf = 976,                /* -gno-strict-dwarf */
  OPT_grecord_gcc_switches = 977,            /* -grecord-gcc-switches */
  OPT_gstabs = 978,                          /* -gstabs */
  OPT_gstabs_ = 979,                         /* -gstabs+ */
  OPT_gstrict_dwarf = 980,                   /* -gstrict-dwarf */
  OPT_gtoggle = 981,                         /* -gtoggle */
  OPT_gvms = 982,                            /* -gvms */
  OPT_gxcoff = 983,                          /* -gxcoff */
  OPT_gxcoff_ = 984,                         /* -gxcoff+ */
  OPT_h = 985,                               /* -h */
  OPT_idirafter = 986,                       /* -idirafter */
  OPT_imacros = 987,                         /* -imacros */
  OPT_imultiarch = 988,                      /* -imultiarch */
  OPT_imultilib = 989,                       /* -imultilib */
  OPT_include = 990,                         /* -include */
  ...
  OPT_k8 = 998,                              /* -k8 */
  OPT_l = 999,                               /* -l */
  OPT_lang_asm = 1000,                       /* -lang-asm */
  OPT_mabi_ = 1001,                          /* -mabi= */
  OPT_mabicalls = 1002,                      /* -mabicalls */
  OPT_mabs2008 = 1003,                       /* -mabs2008 */
  OPT_mad = 1004,                            /* -mad */
  OPT_march_ = 1005,                         /* -march= */
  OPT_mbranch_cost_ = 1006,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1007,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1008,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1009,                /* -mcode-readable= */
  /* OPT_mcode_xonly = 1010, */              /* -mcode-xonly */
  OPT_mcompact_eh = 1011,                    /* -mcompact-eh */
  OPT_mdebug = 1012,                         /* -mdebug */
  OPT_mdebugd = 1013,                        /* -mdebugd */
  OPT_mdivide_breaks = 1014,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1015,                  /* -mdivide-traps */
  OPT_mdmx = 1016,                           /* -mdmx */
  OPT_mdouble_float = 1017,                  /* -mdouble-float */
  OPT_mdsp = 1018,                           /* -mdsp */
  OPT_mdspr2 = 1019,                         /* -mdspr2 */
  OPT_meb = 1020,                            /* -meb */
  OPT_mel = 1021,                            /* -mel */
  OPT_membedded_data = 1022,                 /* -membedded-data */
  OPT_meva = 1023,                           /* -meva */
  OPT_mexplicit_relocs = 1024,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1025,                  /* -mextern-sdata */
  OPT_mfix_24k = 1026,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1027,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1028,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1029,                     /* -mfix-r4400 */
  OPT_mfix_sb1 = 1030,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1031,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1032,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1033,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1034,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1035,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1036,                 /* -mfp-exceptions */
  OPT_mfp32 = 1037,                          /* -mfp32 */
  OPT_mfp64 = 1038,                          /* -mfp64 */
  OPT_mframe_header_opt = 1039,              /* -mframe-header-opt */
  OPT_mfused_madd = 1040,                    /* -mfused-madd */
  OPT_mgp32 = 1041,                          /* -mgp32 */
  OPT_mgp64 = 1042,                          /* -mgp64 */
  OPT_mgpopt = 1043,                         /* -mgpopt */
  OPT_mhard_float = 1044,                    /* -mhard-float */
  OPT_minterlink_mips16 = 1045,              /* -minterlink-mips16 */
  OPT_mips = 1046,                           /* -mips */
  OPT_mips16 = 1047,                         /* -mips16 */
  OPT_mips16e = 1048,                        /* -mips16e */
  OPT_mips3d = 1049,                         /* -mips3d */
  OPT_mjals = 1050,                          /* -mjals */
  OPT_mllsc = 1051,                          /* -mllsc */
  OPT_mlocal_sdata = 1052,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1053,                    /* -mlong-calls */
  OPT_mlong32 = 1054,                        /* -mlong32 */
  OPT_mlong64 = 1055,                        /* -mlong64 */
  OPT_mmcount_ra_address = 1056,             /* -mmcount-ra-address */
  OPT_mmcu = 1057,                           /* -mmcu */
  OPT_mmemcpy = 1058,                        /* -mmemcpy */
  OPT_mmicromips = 1059,                     /* -mmicromips */
  OPT_mmt = 1060,                            /* -mmt */
  OPT_mnan2008 = 1061,                       /* -mnan2008 */
  /* OPT_mno_data_in_code = 1062, */         /* -mno-data-in-code */
  OPT_mno_float = 1063,                      /* -mno-float */
  OPT_mno_flush_func = 1064,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1065,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1066,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1067,                     /* -mno-mips3d */
  OPT_mocteon_useun = 1068,                  /* -mocteon-useun */
  OPT_mpaired_single = 1069,                 /* -mpaired-single */
  OPT_mplt = 1070,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1071,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1072,               /* -mrelax-pic-calls */
  OPT_mshared = 1073,                        /* -mshared */
  OPT_msingle_float = 1074,                  /* -msingle-float */
  OPT_msmartmips = 1075,                     /* -msmartmips */
  OPT_msoft_float = 1076,                    /* -msoft-float */
  OPT_msplit_addresses = 1077,               /* -msplit-addresses */
  OPT_msym32 = 1078,                         /* -msym32 */
  OPT_msynci = 1079,                         /* -msynci */
  OPT_mtune_ = 1080,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1081,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1082,                  /* -mvr4130-align */
  OPT_mxgot = 1083,                          /* -mxgot */
  OPT_n = 1084,                              /* -n */
  OPT_no_canonical_prefixes = 1085,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1086,              /* -no-integrated-cpp */
  OPT_noasmopt = 1087,                       /* -noasmopt */
